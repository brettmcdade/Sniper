    ...
    <div class="media media--single">
      <div class="grid grid--1to3 grid--first-row">
        <div class="grid__column block-thumb">
          ...
          <div class="b-text">
            <div class="js-action js-play-single" data-title="Test" data-streamurl="http://brettmcdade.com/audio/13 - Lloyd Banks - Holding You Down">
          ...
          <div class="media media--album">
            ...
            <div class="media__block grid grid--1to2">
              <div class="grid__column block-thumb">
                ...
                <div class="block-text">
                  <div class="b-cta">
                    <a class="button button--inverse-theme" href="#">Download</a>
                </div>
                </div>
              </div>
