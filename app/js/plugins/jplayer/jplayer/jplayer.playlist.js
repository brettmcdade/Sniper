...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			listItem += "<div class='small-10 columns'> <span class='track-number'>" + trackNumber + ".</span><a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" + media.title + (media.artist ? " <span class='jp-artist'>by " + media.artist + "</span>" : "") + "</div></a>" + (media.tracktime ? "<div class='small-2 columns'> <div class='tracktime'>" + media.tracktime + "</div></div>" : "");
			listItem += "</li>";
		...
		// Add track to beginning of playlist
		addToBeginning: function(media, playNow) {
		...
		var table = document.getElementById("guts"); 
